          ...
          <Section>
            <GalleryWrapper>
              <div className="item item-1">
                <Img className="gal-img" fluid={img1} />
                <div className="info">Awesome pizza</div>
              </div>
              <div className="item item-2">
                <Img className="gal-img" fluid={img2} />
                <div className="info">Awesome pork</div>
              </div>
              <div className="item item-3">
                <Img className="gal-img" fluid={img3} />
                <div className="info">Awesome steak</div>
              </div>
            </GalleryWrapper>
          </Section>
        )
